        ...
        {blogs.map((blog, index) => (
          <div key={index} className="rounded-lg shadow-md overflow-hidden dark:border-2">
            ...
            <Image
              src={blog.image}
              alt={blog.title}
              width={500}          // apni image size ke mutabiq adjust karen
              height={320}         // apni image size ke mutabiq adjust karen
            ...
            <div className="p-4">
              ...
              {/* Replace double quotes to escape JSX warning */}
              <p className="mb-4">{blog.description.replace(/"/g, '&quot;')}</p>
